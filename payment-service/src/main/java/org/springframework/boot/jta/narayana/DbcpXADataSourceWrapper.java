...
public class DbcpXADataSourceWrapper implements XADataSourceWrapper {
    ...
    @Autowired
    private NarayanaProperties props;
...
//    private TransactionManager tm;
    ...
    public DataSource wrapDataSource(XADataSource xaDataSource) throws Exception {
        ...
        NarayanaXADataSourceWrapper xds = new NarayanaXADataSourceWrapper(recoveryManager, props);
        
        return xds.wrapDataSource(xaDataSource);
